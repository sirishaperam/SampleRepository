...
<body>
	<!--header-->
										...
										<ul class="dropdown-menu multi-column columns-3">
											<div class="row">
												<div class="col-sm-3  multi-gd-img">
													<ul class="multi-column-dropdown">
														<h6>Submenu1</h6>
														<li><a href="products1.jsp">Clothing</a></li>
														<li><a href="products1.jsp">Wallets</a></li>
														<li><a href="products1.jsp">Shoes</a></li>
														<li><a href="products1.jsp">Watches</a></li>
														<li><a href="products1.jsp"> Underwear </a></li>
												...
												<div class="col-sm-3  multi-gd-img">
													<ul class="multi-column-dropdown">
														...
														<li><a href="products1.jsp">Wallets,Bags</a></li>
														<li><a href="products1.jsp">Footwear</a></li>
														<li><a href="products1.jsp">Watches</a></li>
														<li><a href="products1.jsp">Accessories</a></li>
		...
		<div class="banner1">
			<div class="container">
				<h3><a href="index.jsp">Home</a> / <span>Single</span></h3>
			</div>
		</div>
	<!--banner-->
								...
								<div class="col-md-4 product-grid">
									<div id="owl-demo" class="owl-carousel">
										...
										<div class="item">
											<div class="recent-grids">
												<div class="recent-left">
													<a href="single.jsp"><img class="img-responsive " src="images/r4.jpg" alt=""></a>	
												</div>
												<div class="recent-right">
													<h6 class="best2"><a href="single.jsp">Lorem ipsum dolor </a></h6>
													<div class="block">
											...
											<div class="recent-grids">
												<div class="recent-left">
													<a href="single.jsp"><img class="img-responsive " src="images/r5.jpg" alt=""></a>	
												</div>
												<div class="recent-right">
													<h6 class="best2"><a href="single.jsp">Duis aute irure </a></h6>
													<div class="block">
